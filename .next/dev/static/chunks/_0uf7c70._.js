...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$orderId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/orderId.ts [app-client] (ecmascript)");
...
const CartProvider = ({ children })=>{
            ...
            try {
                ...
                if (stored) {
                    ...
                    const validated = parsed.map({
                        "CartProvider.useEffect.validated": (item)=>{
                            const product = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRODUCTS"].find({
                                "CartProvider.useEffect.validated": (p)=>p.id === item.product.id
                            }["CartProvider.useEffect.validated"]) || item.product;
                            const validAddOns = item.selectedAddOns || [];
                            const addOnsSum = validAddOns.reduce({
                                "CartProvider.useEffect.validated.addOnsSum": (sum, a)=>sum + a.price
                            }["CartProvider.useEffect.validated.addOnsSum"], 0);
                    ...
                    }["CartProvider.useEffect.validated"]).filter({
                        "CartProvider.useEffect.validated": (item)=>item.quantity > 0
                    }["CartProvider.useEffect.validated"]);
                    setItems(validated);
                }
            } catch (e) {
    ...
    const totalItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[totalItems]": ()=>{
            return items.reduce({
                "CartProvider.useMemo[totalItems]": (acc, item)=>acc + item.quantity
    ...
    const subtotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[subtotal]": ()=>{
            return items.reduce({
                "CartProvider.useMemo[subtotal]": (acc, item)=>acc + item.unitTotalPrice * item.quantity
    ...
    const createOrder = async (customerName, whatsapp, notes, proofImage)=>{
        ...
        const newOrder = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$orderId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateOrderId"])(),
...
_s(CartProvider, "V3TY4A0MHFI1YyhwRHq9OO9dlbk=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
"[project]/src/utils/orderId.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_0uf7c70._.js.map